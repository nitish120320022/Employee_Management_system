...
public class Updateemployee extends JFrame implements ActionListener {
    ...
    JTextField tfeducation, tffname, tfaddress, tfcontact, tfaadhar, tfemail, tfsalary, tfdesignation;
    JLabel lblempid;
    JButton add, back;
    String empid;
    ...
    Updateemployee(String empid){
        ...
        tfeducation.setBounds(650, 350, 150, 30);
        add(tfeducation);
    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource() == add){
            ...
            try{
                Conn conn = new Conn();
                String query = "update employee set fname ='"+fname+"',salary='"+salary+"',address='"+address+"',contact='"+contact+"',email='"+email+"',education='"+education+"',designation='"+designation+"'where empid='"+empid+"'";
